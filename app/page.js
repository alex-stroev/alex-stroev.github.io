  ...
  return (
    <div className={styles.kernel}>
      ...
      <ul>
        ...
        <li>Умею выдерживать баланс между автономностью и&nbsp;коммуникабельностью. Не&nbsp;стесняюсь задавать вопросы, но&nbsp;в&nbsp;&laquo;нянечке&raquo; не&nbsp;нуждаюсь. В&nbsp;свою очередь, всегда готов придти коллеге на&nbsp;помощь.
        </li>
        <li>Есть опыт координации работы небольших команд (дизайн-бэк-другие фронты при наличии)
        </li>
        <li>
