    ...
    <div className={styles.kernel}>
      ...
      <ul>
        ...
        <li>
          ...
          и&nbsp;коммуникабельностью. Не&nbsp;стесняюсь задавать вопросы,
          но&nbsp;в&nbsp;&laquo;нянечке&raquo; не&nbsp;нуждаюсь. В&nbsp;свою
          очередь, всегда готов прийти коллеге на&nbsp;помощь.
        </li>
        <li>
          Есть опыт координации работы небольших команд (дизайн-бэк-другие
          фронты при наличии)
        </li>
        <li>
